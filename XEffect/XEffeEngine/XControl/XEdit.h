...
//	char *m_selectString;	//选取的字符串
	...
	char m_selectMouseDown;	//鼠标是否按下准备片选
...
public:
	...
	int setACopy(const _XEdit &temp);				//设置为一个拷贝公用部分资源		
	...
	void setCallbackFun(void (* funInputChenge)(void *,int),void (* funInputOver)(void *,int),void *pClass);		//设置回调函数
