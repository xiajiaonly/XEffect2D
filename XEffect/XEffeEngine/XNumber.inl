//inline нд╪Ч
inline int _XNumber::setNumber(const char *temp)
{
...
inline void _XNumber::setColor(const _XFColor& color)
{
...
inline void _XNumber::setSize(const _XVector2& size)
{
...
inline void _XNumber::setPosition(const _XVector2& position)
{
