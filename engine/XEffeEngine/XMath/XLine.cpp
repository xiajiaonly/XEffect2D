...
#include "XLine.h"
namespace XE{
void XLine::set(const XVector2& startPosition,const XVector2 &endPosition)
{
...
void XLine::setStartPosition(const XVector2& startPosition)
{
	m_startPosition = startPosition;
	XMath::twoPointLine(m_startPosition,m_endPosition,&A,&B,&C);
	m_data0 = A * A + B * B;
...
void XLine::setEndPosition(const XVector2& endPosition)
{
