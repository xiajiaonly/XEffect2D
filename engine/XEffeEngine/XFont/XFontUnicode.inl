//inline º¯Êý
INLINE void XFontUnicode::setRotateBasePoint(const XVec2& r)
{
...
INLINE int XFontUnicode::getTextIndex(const char p[UNICODE_BYTES_WIDTH])const	//ÕÒµ½Ö¸¶¨µÄ×Ö·ûËùÔÚµÄÎ»ÖÃ
{
...
ÊÏËÏÌÏÍÏÎÏÏÏÐÏÑÏÒÏÓÏÔÏÕÏÖÏ×Ï°Ð±Ð²Ð³Ð´ÐµÐ¶Ð·Ð¸Ð¹ÐºÐ»Ð¼Ð½Ð¾Ð¿ÐÀÐÁÐÂÐÃÐÄÐÅÐÆÐÇÐÈÐÉÐÊÐËÐÌÐÍÐÎÐÏÐÐÐÑÐÒÐÓÐÔÐÕÐÖÐ×ÐãÐ°Ñ±Ñ²Ñ³Ñ´ÑµÑ¶Ñ\
