...
,m_isEnd(0)
{}
int XFireWorkParticles::init(const XVector2& position,const XVector2& initSpeed,float decreaseSpeed,float gravity,int atomSum,const XTexture *texture)
{
...
void XFireWorkParticles::reset()
{
	...
	for(int i = 0;i < m_atomSum;++ i)
	{
		...
		temp2 = XRand::random(4000) * PI/2000.0f;
		temp3 = XRand::random(100)/100.0f * 0.75f + 0.25f;
