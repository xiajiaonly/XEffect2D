...
public:
	...
	_XBool m_needRotate;		//物体被放入之后是否需要进行旋转
};
...
private:
	...
	void updatePutOperate(_XObjectBox &objectBox,_XBasicBox &basicBox,_XBool needRotate,float positionX,float positionY);	//完成放入操作，标记相应的属性
	...
	_XBool m_canRotate;			//是否支持旋转，这种旋转只支持0或者90度的旋转不能支持任意角度的旋转
public:
