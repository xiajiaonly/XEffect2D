...
bool XWindowTitle::init()
{
	...
	m_minSizeBtn.initWithoutSkin("-", getDefaultFont(), XRect(0.0f, 0.0f, MIN_FONT_CTRL_SIZE, MIN_FONT_CTRL_SIZE));
	m_minSizeBtn.setPosition(XEG.m_windowData.sceneW - MIN_FONT_CTRL_SIZE * 3.0f, -MIN_FONT_CTRL_SIZE);
	m_minSizeBtn.setEventProc(ctrlProc,this);
	m_exitBtn.initWithoutSkin("X", getDefaultFont(), XRect(0.0f, 0.0f, MIN_FONT_CTRL_SIZE, MIN_FONT_CTRL_SIZE));
	m_exitBtn.setPosition(XEG.m_windowData.sceneW - MIN_FONT_CTRL_SIZE * 2.0f, -MIN_FONT_CTRL_SIZE);
	m_exitBtn.setEventProc(ctrlProc,this);
	m_iconBtn.initWithoutSkin(">", getDefaultFont(), XRect(0.0f, 0.0f, MIN_FONT_CTRL_SIZE, MIN_FONT_CTRL_SIZE));
	m_iconBtn.setPosition(XEG.m_windowData.sceneW - MIN_FONT_CTRL_SIZE, -MIN_FONT_CTRL_SIZE);
	m_iconBtn.disable();
