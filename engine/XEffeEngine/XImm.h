...
namespace XImm
{
	...
	extern const std::string& getImmDescription();		//获取当前输入法的描述文本
	extern const std::string& getImmFilename();		//获取当前输入法的文件名
	extern void setCompositionPos(float x, float y);			//设置输入法的显示位置
	extern bool getIsCompositionStrChange();	//输入框的字符串是否发生了改变
	extern const std::string& getCompositionStr();		//获取当前输入框的字符串
	...
	extern const std::string& getCandidateListStr(int index);	//获取候选列表中的字符串
