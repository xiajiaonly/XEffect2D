...
XBool XGroup::init(const XVector2& position,
	const XRect &rect,
	const char *caption,const XFontUnicode &font,float captionSize)
{
	...
	if(!m_stateBotton.initWithoutSkin("-",font,captionSize,XRect(0.0f,0.0f,m_groupStateBtnSize,m_groupStateBtnSize),
		XVector2(m_groupStateBtnSize * 0.5f,m_groupStateBtnSize * 0.5f))) return XFalse;
...
void XGroup::draw()
{
	...
	if(m_withRect)
	{
		if(m_state == STATE_NORMAL)
		{
			...
			XRender::drawLine(m_drawRect.left,m_drawRect.bottom,m_drawRect.right,m_drawRect.bottom,1,m_color);
		...
		{
			XRender::drawLine(m_drawRect.left,m_drawRect.top,m_drawRect.left,m_drawRect.bottom,1,m_color);
			XRender::drawLine(m_drawRect.right,m_drawRect.top,m_drawRect.right,m_drawRect.bottom,1,m_color);
			XRender::drawLine(m_drawRect.left,m_drawRect.bottom,m_drawRect.right,m_drawRect.bottom,1,m_color);
			XRender::drawLine(m_drawRect.left,m_drawRect.top,m_drawRect.right,m_drawRect.top,1,m_color);
		}
	}
	m_caption.draw();
//	m_stateBotton.draw();
