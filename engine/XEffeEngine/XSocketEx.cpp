...
bool _XSocketEx::connectToNet()	//连接到网络
{
	switch(m_conState)
	{
...
void _XSocketEx::requestRename()	//向服务器发送更名请求
{
	_XSocketDataPack *tempPacket = createMem<_XSocketDataPack>();
	if(tempPacket == NULL) return;
	tempPacket->fromID = m_myID;
