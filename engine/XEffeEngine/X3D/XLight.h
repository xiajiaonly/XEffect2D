...
{
private:
	XVector4 m_ambient;	//灯的颜色
	XVector4 m_diffuse;	//散射的颜色？
	XVector4 m_position;	//灯光的位置
	XVector4 m_specular;	//目前尚不知道这个是干啥的
	int m_index;			//灯光的编号 [1 - n]

	//射灯的方向
	XVector3 m_lookAtPosition;		//射灯目标点的位置
	XVector3 m_direction;			//射灯的方向
	XMatrix4x4 m_projectMatrix;	//射灯的世界矩阵
	XMatrix4x4 m_viewMatrix;		//射灯的观察矩阵
	XVector3 m_angle;
	float m_len;
