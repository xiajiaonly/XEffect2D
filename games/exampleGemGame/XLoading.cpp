...
void _XLoading::init(_XVector2 windowSize,_XResourcePosition resoursePosition)
{
...
DWORD WINAPI _XLoading::loadingProc(void * pParam)
{
	...
	pPar->m_gameTitleMoveData.set(120.0f,350.0f,0.05f,MOVE_DATA_MODE_LINE);

	_XNumber Number;
	Number.init("ResourcePack/normalResource/Number.png",_XVector2(15,30),_XVector2(8,2),pPar->m_resoursePosition);
	Number.setPosition(10,10);
	_XProgressTexture ProgressTexture;
	ProgressTexture.init("ResourcePack/normalResource/Progress/PB_00.png","ResourcePack/normalResource/Progress/PM_00.png","ResourcePack/normalResource/Progress/PU_00.png",pPar->m_resoursePosition);
...
//	m_loadingBG.setIsResizeCenter(POINT_LEFT_TOP);
	...
	Number.init("ResourcePack/pic/Number.png",_XVector2(15,30),_XVector2(8,2),m_resoursePosition);
	Number.setPosition(10,10);
