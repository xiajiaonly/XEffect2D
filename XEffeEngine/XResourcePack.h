...
public:
	...
	bool m_haveReadedFileList;								//是否已经读取索引信息
	bool m_haveReadedNormalFileList;						//是否已经读取了普通文件索引信息
...
private:
	char m_isGetOptimizeInfo;
	int getOptimizeInfo();
	int releaseOptimizeInfo();
